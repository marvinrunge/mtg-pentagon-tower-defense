...
- `docs/BOSS_LORDS_DESIGN.md`: the second boss per colour - tribal lords whose aura buffs the wave around them, the MTG cards behind them, the phased implementation plan and the asset prompts
